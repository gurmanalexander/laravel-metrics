...
class MetricsTableCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create a migration for the metrics table';
    ...
    public function fire()
    {
        ...
        $this->files->put($fullPath, $this->files->get(__DIR__.'/stubs/metrics.stub'));
